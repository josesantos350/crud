...
$banco->query("SELECT * FROM Disciplina ORDER BY Cod_Disciplina ASC");
         ...
         <!-- Sidebar Holder -->
            <nav id="sidebar">
              ...
              <!--   <ul class="list-unstyled CTAs">
                      ...
                      <caption>Lista de Disciplina</caption>
                      <thead>
                        <tr>
                          <th scope="col">Id</th>
                      ...
                      <tbody>
                              ...
                              foreach ($banco->result() as $disciplina){
                                 echo "<tr>";
                                 echo "<td>".$disciplina['Cod_Disciplina']."</td>"; 
                                 echo "<td>".$disciplina['Nome_Disciplina']."</td>";
                                 echo "<td>".$disciplina['Cod_Departamento']."</td>";
                                 echo "<td>".$disciplina['Carga_Horaria']."</td>";
