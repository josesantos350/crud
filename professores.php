...
$banco->query("SELECT * FROM professor ORDER BY Cod_Professor ASC");
            ...
            <nav id="sidebar">
              ...
              <!--   <ul class="list-unstyled CTAs">
                      ...
                      <tbody>
                              ...
                              foreach ($banco->result() as $professor){
                                 echo "<tr>";
                                 echo "<td>".$professor['Cod_Professor']."</td>"; 
                                 echo "<td>".$professor['Nome_Professor']."</td>";
                                 echo "<td>".$professor['Sobrenome_Professor']."</td>";
                                 echo "<td>".$professor['Status_Professor']."</td>";
                                 echo "<td>".$professor['Cod_Departamento']."</td>";                
